...
The reference data lives in `example/ref/output/` and is regenerated by the programs in `example/ref/` (built with `-DFBR_EXAMPLE_REF=ON`); see `example/ref/readme.txt`.
