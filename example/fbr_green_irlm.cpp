...
// orbital basis at every time. That is what Fbr_ns_dyn gives: the orbital
...
/// The states of one Fbr_ns_dyn share their Slater determinant, so the state
...
int main(int argc, char** argv)
{
    ...
    // where they differ; Fbr_ns_dyn widens it for that. A tight tolerance keeps
